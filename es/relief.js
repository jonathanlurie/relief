import { PerspectiveCamera, Scene, AmbientLight, DirectionalLight, WebGLRenderer, PCFSoftShadowMap, Raycaster, Vector2, TorusKnotBufferGeometry, MeshPhongMaterial, Mesh, Vector3, Quaternion, EventDispatcher, Object3D, PlaneBufferGeometry, DoubleSide } from 'three';
...
class ReliefBuilder {
  ...
  createFromRaster(data, width, height) {
    ...
    let geometry = new PlaneBufferGeometry(20*(width-1), 20*(height-1), width-1, height-1);
